...
import { MapPin, Music, Calendar, Phone, Mail } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="text-center">
                <h3 className="text-xl font-bold text-emerald-600 mb-4">English</h3>
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-emerald-600 mb-4">Português</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-emerald-600 mb-4">Español</h3>
                <p className="text-gray-700 leading-relaxed">
